 ...
 */
public class GattseriveceListAdapter extends BaseAdapter {
	ArrayList<HashMap<String, BluetoothGattService>> mGattServiceData;
	private Context mContext;

	public GattseriveceListAdapter(Context mContext,
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		// Adding the available service to the DataLogger
		Logger.datalog("Availble Service UUID " + bgs.getUuid().toString()
				+ " : " + name, mContext);
