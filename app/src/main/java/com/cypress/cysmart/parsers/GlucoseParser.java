...
import com.cypress.cysmart.datamodels.GlucoseDataModel;
...
public class GlucoseParser {
	 ...
	 * @return
	 */
	public static String glucoseType(int lowNibbleTtype) {
		String glucoseType;
	 ...
	 * @return
	 */
	public static String glucoseSampleLocation(int highNibbleSampleLocation) {
		String glucoseSampleLocation;
