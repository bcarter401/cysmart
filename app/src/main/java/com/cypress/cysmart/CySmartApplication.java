...
public class CySmartApplication extends Application {
	...
	ArrayList<HashMap<String, BluetoothGattService>> mgattServiceData = new ArrayList<HashMap<String, BluetoothGattService>>();
	ArrayList<HashMap<String, BluetoothGattService>> mgattServiceMasterData = new ArrayList<HashMap<String, BluetoothGattService>>();
