...
package com.cypress.cysmart.datamodels;

public class ProfileScanningListModel {
	...
	public ProfileScanningListModel(String profileName, String deviceAddress, int icon) {
